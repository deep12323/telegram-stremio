...
@app.api_route("/configure", methods=["GET", "HEAD"], response_class=HTMLResponse)
async def landing(request: Request):
    addon_base_url = get_addon_url(request)
    api_key = request.query_params.get("api_key", "")
    if api_key:
        manifest_url = f"{addon_base_url}/{urllib.parse.quote(api_key)}/manifest.json"
    else:
        manifest_url = f"{addon_base_url}/manifest.json"
    ...
    <html lang="en">
        ...
        <body>
            <div class="app-card">
                ...
                <details class="troubleshoot-details">
                    ...
                    <div class="troubleshoot-content">
                        This error <strong>only occurs in local HTTP deployments</strong>. If you deploy this project to a secure public HTTPS server (such as via Hugging Face Spaces), this installation button will work <strong>flawlessly</strong>.
                        <br><br>
            ...
            <script>
                const baseManifestUrl = "{addon_base_url}/manifest.json";
                ...
                function updateManifestUrl() {{
                    ...
                    if (apiKey) {{
                        ...
                        manifestUrl = "{addon_base_url}/" + encodedKey + "/manifest.json";
